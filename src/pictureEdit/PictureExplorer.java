...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
	...
	/** The image display */
	private PictureViewer imageDisplay;
	...
	private void createAndInitScrollingImage() {
		...
		imageDisplay = new PictureViewer(bimg);
	...
	private void setUpNextAndPreviousButtons() {
		...
		Icon prevIcon;
		Icon nextIcon;
		if (PictureExplorer.class.getResource("PictureExplorer.class").toString().startsWith("jar:")) {
			prevIcon = new ImageIcon(Picture.class.getResource("leftArrow.gif"), "previous index");
			nextIcon = new ImageIcon(Picture.class.getResource("rightArrow.gif"), "next index");
		} else {
			prevIcon = new ImageIcon("leftArrow.gif", "previous index");
			nextIcon = new ImageIcon("rightArrow.gif", "next index");
		}
	...
	public static void main(String args[]) {
		Picture pix = new Picture("i-go-kill-submarine-for-the-motherland.jpg");
		pix.explore();
	}
