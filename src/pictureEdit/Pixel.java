...
public class Pixel {
	...
	// returns specific values from a 32 bit integer that represents a RGBA
	// color
	...
	public void setColor(int alpha, int red, int green, int blue) {
		...
		picture.setBasicPixel(this.x, this.y, value);// might not work, try
														// without (this.) if it
														// does not work.
	...
	public String toString() {
		return "Y= " + getY() + "\nX= " + getX() + "\nAlpha,Red,Green,Blue= " + getAlpha() + "," + getRed() + ","
				+ getGreen() + "," + getBlue();
	}
}
